                ...
                <div class="bg-white rounded-2xl border border-surface-200/60 shadow-sm overflow-hidden">
                    ...
                    <div class="p-6 space-y-5">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-surface-500 mt-1.5">Chat ID dari Telegram untuk menerima notifikasi. Kirim pesan ke bot lalu cek via <code class="text-xs bg-surface-100 px-1 rounded">/getUpdates</code>.</p>
